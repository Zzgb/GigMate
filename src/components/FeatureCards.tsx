...
export default function FeatureCards() {
  return (
    <div className="grid grid-cols-3 gap-5 px-10 py-10">
      {features.map((f) => (
        <div key={f.title} className="bg-white dark:bg-[#2c2c2e] rounded-2xl p-8 border border-[rgba(0,0,0,0.04)] dark:border-[rgba(255,255,255,0.06)] shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
          ...
          <p className="text-sm text-[#86868b] dark:text-[#98989d] leading-relaxed">{f.desc}</p>
        </div>
      ))}
    </div>
  );
